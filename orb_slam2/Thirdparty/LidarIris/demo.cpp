...
int main(int argc, char *argv[])
{
    ...
    //kitti pose xx.txt
    auto gt = getGTFromPose("/media/kinggreat24/Samsung_T5/data/kitti_data_full/odometry/unzip/data/dataset/poses/"+seq +".txt");
    ...
    for(int i =0; i <=N-1 ;i++)
    {
        ...
        // kitti velodyne bins
        std::string filename = "/media/kinggreat24/Samsung_T5/data/kitti_data_full/odometry/unzip/data/dataset/sequences/" + seq + "/velodyne/" + ss.str() + ".bin";
