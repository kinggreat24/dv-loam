...
int ORBmatcher::SearchByBoW(Frame &F1, const Frame& F2, std::vector<cv::DMatch> &vpMatches12)
{
    vpMatches12 = vector<cv::DMatch>(F1.N,cv::DMatch(-1,-1,-1));
...
int ORBmatcher::SearchBruteForce(Frame* frame1, Frame* frame2,
