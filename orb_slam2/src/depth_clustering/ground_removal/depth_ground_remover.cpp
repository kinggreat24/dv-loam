...
void DepthGroundRemover::OnNewObjectReceived(const Cloud &cloud, Cloud & cloud_without_ground)
{
  ...
  cloud_without_ground = Cloud(cloud);
  ...
  cloud_without_ground.projection_ptr()->depth_image() = no_ground_image;
