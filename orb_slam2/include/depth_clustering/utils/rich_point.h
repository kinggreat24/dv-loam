/*
 * @Author: kinggreat24
 * @Date: 2021-04-02 19:45:47
 * @LastEditTime: 2021-04-02 22:33:01
 * @LastEditors: kinggreat24
 * @Description: 
 * @FilePath: /d2vl_slam/orb_slam2/include/depth_clustering/utils/rich_point.h
...
class RichPoint {
 public:
  ...
  explicit RichPoint(float x, float y, float z, uint16_t ring, float intensity)
      : _point{x, y, z}, _ring{ring}, _intensity{intensity} {}
