...
#include "loam/Vector3.h"
#include "loam/CircularBuffer.h"
...
namespace loam
{
  ...
  public:
    ...
    */
    ...
    pcl::PointCloud<pcl::PointXYZ>  const& imuTransform          () { return _imuTrans             ; }
    Time                            const& sweepStart            () { return _sweepStart           ; }
    pcl::PointCloud<pcl::PointXYZI> const& laserCloud            () { return _laserCloud           ; }
    pcl::PointCloud<pcl::PointXYZI> const& cornerPointsSharp     () { return _cornerPointsSharp    ; }
    pcl::PointCloud<pcl::PointXYZI> const& cornerPointsLessSharp () { return _cornerPointsLessSharp; }
    pcl::PointCloud<pcl::PointXYZI> const& surfacePointsFlat     () { return _surfacePointsFlat    ; }
    pcl::PointCloud<pcl::PointXYZI> const& surfacePointsLessFlat () { return _surfacePointsLessFlat; }
    RegistrationParams              const& config                () { return _config               ; }
