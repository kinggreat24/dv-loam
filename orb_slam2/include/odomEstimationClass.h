/*
 * @Author: kinggreat24
 * @Date: 2021-04-12 11:16:57
 * @LastEditTime: 2021-04-12 15:36:04
 * @LastEditors: kinggreat24
 * @Description: 
 * @FilePath: /d2vl_slam/orb_slam2/include/odomEstimationClass.h
...
class SWOdomEstimationClass
{

public:
	SWOdomEstimationClass();
	...
	void updatePointsToMap(Eigen::Matrix4d& Twc,const pcl::PointCloud<pcl::PointXYZI>::Ptr &edge_in, const pcl::PointCloud<pcl::PointXYZI>::Ptr &surf_in);
